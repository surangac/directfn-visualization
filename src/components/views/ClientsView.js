...
const ClientsView = () => {
  // Notable clients
  const clients = ["Boursa Kuwait Exchange", "Al Rajhi Bank", "Saudi National Bank", "Riyad Capital", "HSBC" , "Al Jazeera"];
  
  // DirectFN products
  const products = ["MIX Web", "Pro9-Pro12", "TWS", "DT4-DT6" , "Feed API","BK Exchange Website", "MTR", "AML"];
    ...
    <div className="bg-white p-6 rounded-lg shadow">
      ...
      <div className="mb-8 bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-lg border border-blue-200">
        ...
        <div className="relative w-full h-[450px] overflow-hidden">
          ...
          <div className="absolute top-[100px] left-1/2 h-[80px] w-1 bg-gradient-to-b from-blue-400 to-purple-500"></div>
          ...
          <div className="absolute top-[280px] left-[85%] flex flex-col items-center">
            ...
            <div className="mt-1 font-medium text-red-800 text-sm">MTR Clients</div>
          </div>
          ...
          <svg className="absolute inset-0 w-full h-full" style={{ zIndex: 10 }}>
            {/* Exchange to Backend */}
            <line x1="50%" y1="100px" x2="50%" y2="180px" stroke="#6366f1" strokeWidth="3" />
            
            {/* Backend to Banking */}
            <path d="M 50% 220 L 50% 230 Q 50% 245, 30% 245 L 15% 245 L 15% 280" 
                  stroke="#4ade80" strokeWidth="2" fill="none" />
            
            {/* Backend to Pro */}
            <path d="M 50% 220 L 50% 230 Q 50% 245, 40% 245 L 38% 245 L 38% 280" 
                  stroke="#facc15" strokeWidth="2" fill="none" />
            
            {/* Backend to Feed */}
            <path d="M 50% 220 L 50% 230 Q 50% 245, 60% 245 L 62% 245 L 62% 280" 
                  stroke="#818cf8" strokeWidth="2" fill="none" />
            
            {/* Backend to MRT */}
            <path d="M 50% 220 L 50% 230 Q 50% 245, 70% 245 L 85% 245 L 85% 280" 
                  stroke="#f87171" strokeWidth="2" fill="none" />
            
            {/* Backend to Mobile */}
            <path d="M 50% 220 L 50% 250 Q 50% 310, 25% 310 L 25% 370" 
                  stroke="#c084fc" strokeWidth="2" fill="none" />
            
            {/* Backend to ML */}
            <path d="M 50% 220 L 50% 330 L 50% 370" 
                  stroke="#5eead4" strokeWidth="2" fill="none" />
            
            {/* Backend to AML */}
            <path d="M 50% 220 L 50% 250 Q 50% 310, 75% 310 L 75% 370" 
          ...
          <div className="absolute inset-0">
            ...
            {/* Backend to Banking */}
            <div className="absolute top-[220px] left-1/2 w-2 h-2 bg-green-300 rounded-full shadow-md"
                 style={{ animation: 'moveToBanking 4s infinite', marginLeft: '-1px' }}>
            </div>
            
            {/* Backend to Pro */}
            <div className="absolute top-[220px] left-1/2 w-2 h-2 bg-yellow-300 rounded-full shadow-md"
                 style={{ animation: 'moveToPro 4s infinite 0.5s', marginLeft: '-1px' }}>
            </div>
            
            {/* Backend to Feed */}
            <div className="absolute top-[220px] left-1/2 w-2 h-2 bg-indigo-300 rounded-full shadow-md"
                 style={{ animation: 'moveToFeed 4s infinite 1s', marginLeft: '-1px' }}>
            </div>
            
            {/* Backend to MRT */}
            <div className="absolute top-[220px] left-1/2 w-2 h-2 bg-red-300 rounded-full shadow-md"
                 style={{ animation: 'moveToMRT 4s infinite 1.5s', marginLeft: '-1px' }}>
            </div>
            
            {/* Backend to Mobile */}
            <div className="absolute top-[220px] left-1/2 w-2 h-2 bg-purple-300 rounded-full shadow-md"
                 style={{ animation: 'moveToMobile 5s infinite 2s', marginLeft: '-1px' }}>
            </div>
            
            {/* Backend to ML */}
            <div className="absolute top-[220px] left-1/2 w-2 h-2 bg-teal-300 rounded-full shadow-md"
                 style={{ animation: 'moveToML 5s infinite 2.5s', marginLeft: '-1px' }}>
            </div>
            
            {/* Backend to AML */}
            <div className="absolute top-[220px] left-1/2 w-2 h-2 bg-orange-300 rounded-full shadow-md"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
          <h3 className="font-bold text-blue-800 mb-2 text-center">Price Only</h3>
        ...
        <div className="bg-green-50 p-4 rounded-lg border border-green-200">
          <h3 className="font-bold text-green-800 mb-2 text-center">Price & OMS</h3>
          <ul className="list-disc list-inside text-gray-700">
            <li>DT4-DT6</li>
            <li>TWS</li>
            <li>PRO10-PRO12</li>
        ...
        <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
          <h3 className="font-bold text-purple-800 mb-2 text-center">Feed Business + Third Party Integrations</h3>
          <ul className="list-disc list-inside text-gray-700">
            <li>Feed API</li>
            <li>AML</li>
            <li>MTR</li>
